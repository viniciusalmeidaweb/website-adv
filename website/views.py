...
class HomeListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        especialidade = Especialidades.objects.all()  # Aqui, você pode adicionar qualquer outro queryset
        context['especialidade_list'] = especialidade  # O nome que o objeto terá no template
        return context
